      ...
      xhttp.onreadystatechange = function () {
          if (this.readyState == 4 && this.status == 200) {
              ...
              for (let item of datos) {
                  ...
                  res.innerHTML += "<tr><td>"+item.nombre+"</td><td>"+item.precio+"</td><td>"+item.descripcion_corta+"</td><td><td>"+item.descripcion_larga+"</td><td> <a href='#' class='btn btn-primary' onclick=''>Eliminar</a><br><br></a> <a href='#' class='btn btn-primary' onclick=''>Editar</a><br><br></a></td></tr>"
